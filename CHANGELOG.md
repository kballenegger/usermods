...
- A Playwright harness driving the real extension against a mock LLM: sixteen browser flows
  ...
  editing an installed mod, and resume. The vision flow is the only one that drives the real
  `screenshot` tool, and reads the
