...
| The package | `npm run zip:store` → upload `.output/usermods-0.1.0-chrome.zip`. Current build: 400,699 bytes, sha256 `8175a054e00d82acb75d49107c0b74ea8444a65edd0d2ec159022357e5384caf`. |
