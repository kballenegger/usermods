...
3. ~~Refresh screenshots and store artwork.~~ **Done.** `docs/screenshots/` and `docs/store/assets/` are regenerated, and neither the README nor [screenshots.md](screenshots.md) describes the old Volt design.
